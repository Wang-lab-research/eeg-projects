...
def compute_sub_avg_con_epoch_test(
    sub_id,
    group_name,
    processed_data_path,
    epochs_data_path,
    ...
    # Set tmax 
    tmin = 0.0
    tmax = 1.25  # exclude the baseline period for connectivity estimation
    
    # Initialize dictionary for this subject
    sub_con_dict = {}

    # Resting state
    label_ts_EO_epochs = utils.unpickle_data(epochs_data_path, f"{sub_id}_eyes_open-epochs.pkl")
    print("unpickled")
    ...
    # Use only label_ts from overlap of condition_dict and conditions
    desired_label_ts = ["Eyes Open Epochs"]
